...
def data_engineering(df, use_dates, test_date):
...
#use_dates = ['2016-03-28', '2016-04-28', '2016-05-28']
...
def split_data(trn, features):
    ...
    # 訓練、検証データに分離します。
    #vld_date = '2016-05-28'
    vld_dates = ['2016-05-28']
    
    #XY_trn = XY[XY['fecha_dato'] != vld_date]
    #XY_vld = XY[XY['fecha_dato'] == vld_date]
    XY_trn = XY[~XY['fecha_dato'].isin(vld_dates)]
    XY_vld = XY[XY['fecha_dato'].isin(vld_dates)]
...
# def get_xgb_data(X_trn, Y_trn, X_vld, Y_vld, features):
#     dtrn = xgb.DMatrix(X_trn, label=Y_trn, feature_names=features)
#     dvld = xgb.DMatrix(X_vld, label=Y_vld, feature_names=features)
#     return dtrn, dvld
